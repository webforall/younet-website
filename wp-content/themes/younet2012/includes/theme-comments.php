		...
		<li <?php comment_class(); ?>>
			...
			<div class="comment-main fr">
		      	<div class="comment-head">
	                ...
	                <span class="perma"><a href="<?php echo get_comment_link(); ?>" title="<?php esc_attr_e( 'Direct link to this comment', 'woothemes' ); ?>"><img src="<?php bloginfo( 'template_url' ); ?>/images/ico-url.png" alt="" /></a></span>
