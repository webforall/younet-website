...
<ol>
	...
	<li>Prefisso tabelle (se si desidera eseguire pi&ugrave copie di WordPress su un singolo database) </li>
</ol>
<p><strong>Se per qualsiasi ragione questo file di creazione automatica non dovesse funzionare, non preoccupatevi. Tutto ci&ograve; che fa &egrave; compilare il file di configurazione con le informazioni sul database. &egrave; possibile anche in maniera semplice aprire il file  <code>wp-config-sample.php</code> in un qualsiasi editor di testi, compilare manualmente le informazioni e salvarlo come <code>wp-config.php</code>. </strong></p>
<p>Con tutta probabilit&agrave;, queste informazioni vi sono state indicate dal vostro fornitore di hosting. Se non si dispone di queste informazioni, occorrer&agrave; contattare il vostro fornitore prima di proseguire. Se si &egrave; pronti a proseguire&hellip;</p>
...
<form method="post" action="setup-config.php?step=2">
	<p>Di seguito occorrer&agrave; inserire le informazioni sulla connessione al database connection details. Se non si &egrave; sicuri del significato o del valore di queste impostazioni, contattare il proprio fornitore di hosting. </p>
	<table class="form-table">
		...
		<tr>
			...
			<td>Cambiare questo valore se si desidera eseguire pi&ugrave; installazioni di WordPress su di un singolo database.</td>
		</tr>
	</table>
...
<?php
	...
	if ( ! is_writable(ABSPATH) ) :
		display_header();
?>
<p>Spiacente, non &egrave; possibile scrivere il file <code>wp-config.php</code>.</p>
...
<?php
		...
		display_header();
?>
<p>Tutto ok! Si &egrave; conclusa la prima parte dell'installazione. Ora WordPress pu&ograve; comunicare con il database. Se si &egrave; pronti ora &egrave; il momento di&hellip;</p>
